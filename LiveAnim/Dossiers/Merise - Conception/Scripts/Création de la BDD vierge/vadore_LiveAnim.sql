...
--
-- Client: localhost
-- Généré le : Mer 07 Septembre 2011 à 09:56
...
--
-- Base de données: `vadore_LiveAnim`
--
...
CREATE TABLE IF NOT EXISTS `annonce` (
  ...
  `TYPE_ANNONCE` char(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `contrat` (
  ...
  `STATUT_CONTRAT` char(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `evaluation` (
  ...
  `TYPE_EVALUATION` char(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `message` (
  ...
  `TYPE_MESSAGE` char(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `message_personne` (
  ...
  `ID_PERSONNE` bigint(20) NOT NULL,
  `STATUT_MESSAGE` char(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `personne` (
  ...
  `CIVILITE` char(100) NOT NULL,
  `EMAIL` char(100) NOT NULL,
  `MDP` char(50) NOT NULL,
  `TYPE_PERSONNE` char(100) NOT NULL,
  `STATUT_PERSONNE` char(100) NOT NULL,
  `CONNAISSANCE_SITE` char(100) NOT NULL,
...
INSERT INTO `personne` (`ID_PERSONNE`, `PSEUDO`, `NOM`, `PRENOM`, `DESCRIPTION`, `URL_PHOTO_PRINCIPALE`, `DATE_NAISSANCE`, `CIVILITE`, `EMAIL`, `MDP`, `TYPE_PERSONNE`, `STATUT_PERSONNE`, `CONNAISSANCE_SITE`, `NEWSLETTER`, `OFFRES_ANNONCEURS`, `DEPARTEMENTS`, `VILLE`, `ADRESSE`, `CP`, `TEL_FIXE`, `TEL_PORTABLE`, `PARRAIN`, `SIRET`, `TARIFS`, `DISTANCE_PRESTATION_MAX`, `CV_VIDEO`, `MATERIEL`, `VISIBLE`, `DATE_BANNISSEMENT`, `PERSONNE_SUPPRIMEE`, `DATE_SUPPRESSION_REELLE`, `RAISON_SUPPRESSION`) VALUES
(2, 'Vado', 'Dhenain', 'Ambroise', NULL, NULL, '0000-00-00', 'Mr', 'ambroisedhenain@hotmail.fr', '£Ö/\0', 'Prestataire', '', 'Facebook', 1, 0, NULL, NULL, NULL, NULL, NULL, NULL, 'Aucun', NULL, NULL, NULL, NULL, NULL, 1, '0000-00-00 00:00:00', 0, '0000-00-00', '');
...
INSERT INTO `types` (`ID_TYPES`, `ID_FAMILLE_TYPES`) VALUES
('Ambiance', 'Caractéristiques'),
('Gestion de son matériel', 'Caractéristiques'),
('Ponctualité', 'Caractéristiques'),
('Prestation', 'Caractéristiques'),
('Relationnel', 'Caractéristiques'),
('Vestimentaire', 'Caractéristiques'),
('Mlle', 'Civilité'),
('Mme', 'Civilité'),
('Mr', 'Civilité'),
('Autres', 'Découverte du site'),
('Facebook', 'Découverte du site'),
('Google+', 'Découverte du site'),
('Moteur de recherche autre', 'Découverte du site'),
('Moteur de recherche Google', 'Découverte du site'),
('MySpace', 'Découverte du site'),
('Par e-mail', 'Découverte du site'),
('Par un ami', 'Découverte du site'),
('Pubs', 'Découverte du site'),
('Twitter', 'Découverte du site'),
('00', 'Evaluation'),
('01', 'Evaluation'),
('02', 'Evaluation'),
('03', 'Evaluation'),
...
('09', 'Evaluation'),
('10', 'Evaluation'),
('Annulé', 'Statut du contrat'),
('En attente', 'Statut du contrat'),
('Refusé', 'Statut du contrat'),
('Validé', 'Statut du contrat'),
('Lu', 'Statut du message'),
('Non lu', 'Statut du message'),
('Répondu', 'Statut du message'),
('Supprimé', 'Statut du message'),
('Alerte', 'Type de message'),
('FAQ', 'Type de message'),
('MàJ', 'Type de message'),
('Message personnel', 'Type de message'),
('News', 'Type de message'),
('Basique', 'Type de pack'),
('Spécial', 'Type de pack'),
('Admin', 'Type de personne'),
('Organisateur', 'Type de personne'),
('Prestataire', 'Type de personne'),
('Anniversaire', 'Type de soirée'),
('Boite de nuit', 'Type de soirée'),
('Boom', 'Type de soirée'),
('Repas', 'Type de soirée'),
('Soirée dansante', 'Type de soirée'),
('Spectacle', 'Type de soirée');
